...
#. On a chromium based browser, such as Chrome, go to the `CharaChorder Device Manager <https://charachorder.io/>`__ (Linux users see :ref:`this link<serialportaccess>` for more information about configuring serial port access).
...
#. Head to the CharaChorder Device Manager `<https://charachorder.io/>`__
