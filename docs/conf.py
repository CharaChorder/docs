...
# for a list of supported languages.
#
# This is the language of the *source* documentation.
language = 'en' # Or 'en_US', whatever your source language is
...
locale_dirs = ['locales']   # directory to store .po files
gettext_compact = False      # optional: creates one .po file per document
                             # set to True for one .po file per directory
